...
PROJECTNAME = "electro/single/random_topo"
...
PAYLOAD:int = 50        # (B) how big payload should be packeet into COAP msg !!IF PAYLOAD = 0 NO COAP WILL BE SEND
...
def create_topo_fixed(ns,
    ...
    for node_position in nodes: 
        x_position = node_position[0]
        y_position = node_position[1]
...
def main(start:int, stop:int = MAIN_STOP):
    ...
    for i in range (start, stop):
        ...
        border_router = ns.add("br", x=300, y=50)
